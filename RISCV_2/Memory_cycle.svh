...
module Memory_cycle(
    ...
    input logic [DATA_WIDTH-1:0] ALUResultM, WriteDataM, PCPlus4M,
    ...
    output logic [REG_ADDR_WIDTH-1:0] RdW
);

logic [DATA_WIDTH-1:0] ReadDataM;

logic RegWriteM_r, ResultSrcM_r;
logic [DATA_WIDTH-1:0] ALUResultM_r, ReadDataM_r, PCPlus4M_r;
logic [REG_ADDR_WIDTH-1:0] RdM_r;
